...
const cacheName = 'Fixit8DemiCamarigg-2020-09-30 20:06:57.951106'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8DemiCamarigg'.length) === 'Fixit8DemiCamarigg') {
